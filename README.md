...
The `MMM-CloneWarsQuotes` is a https://github.com/MichMich/MagicMirror module that displays a random intro quote (Jedi proverb) from _The Clone Wars_ television series, seasons 1-7.
